...
/***/ "./src/declarations/dAuction/dAuction.did.js":
/*!***************************************************!*\
  !*** ./src/declarations/dAuction/dAuction.did.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const idlFactory = ({ IDL }) => {
  return IDL.Service({
    ...
    'checkName' : IDL.Func([], [IDL.Text], ['query']),
    'topUp' : IDL.Func([IDL.Float64, IDL.Text], [], ['oneway']),
  });
};
...
/***/ "./src/declarations/dAuction/index.js":
/*!********************************************!*\
  !*** ./src/declarations/dAuction/index.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _dAuction_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "dAuction": () => (/* binding */ dAuction)
/* harmony export */ });
...
/* harmony import */ var _dAuction_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dAuction.did.js */ "./src/declarations/dAuction/dAuction.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dAuction.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_dAuction_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the dAuction canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dAuction.did.js")._SERVICE>}
 */
 const dAuction = createActor(canisterId);
...
"use strict";
/*!******************************************!*\
  !*** ./src/dAuction_assets/src/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_dAuction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/dAuction */ "./src/declarations/dAuction/index.js");
...
document.querySelector("form").addEventListener("submit", async function(event){
  ...
  {
    await _declarations_dAuction__WEBPACK_IMPORTED_MODULE_0__.dAuction.topUp(inputAmount,inputName);
  }
  update();
...
async function update() {
  const currentAmount = await _declarations_dAuction__WEBPACK_IMPORTED_MODULE_0__.dAuction.checkBalance();
  const currentBidder = await _declarations_dAuction__WEBPACK_IMPORTED_MODULE_0__.dAuction.checkName();
